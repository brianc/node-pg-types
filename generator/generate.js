...
// Legacy types that were removed in newer PostgreSQL versions
// These maintain backward compatibility for older applications
const legacyTypes = {
  SMGR: 210,
  ABSTIME: 702, // Deprecated: 7, Removed: 12
  RELTIME: 703, // Deprecated: 7, Removed: 12
  TINTERVAL: 704 // Deprecated: 7, Removed: 12
}
...
async function generate () {
  ...
  // Add legacy types for backward compatibility
  allTypes = { ...allTypes, ...legacyTypes }
...
type coverage for parsing. Includes legacy types for backward compatibility.
