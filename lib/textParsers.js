...
var parsePointArray = function (value) {
  if (!value) { return null }
  var p = arrayParser.create(value, parsePoint)
...
var parseFloatArray = function (value) {
  if (!value) { return null }
  var p = arrayParser.create(value, parseFloat)
...
var parseDateArray = function (value) {
  ...
  var p = arrayParser.create(value, parseDate)
...
var parseIntervalArray = function (value) {
  ...
  var p = arrayParser.create(value, parseInterval)
